...
define('BOT_TOKEN', '223202635:AAGTUFRqFr-zqGe9EtBeSIJBMzAeM0jtfhA');
...
🗣پیام ارسال شد");
        ...
        $phptext = str_replace("223202635:AAGTUFRqFr-zqGe9EtBeSIJBMzAeM0jtfhA",$matches[1],$phptext);
        $phptext = str_replace("240616380",$chat_id,$phptext);
...
🗣پیام ارسال شد");
        $phptext = file_get_contents('phptext.txt');
        $phptext = str_replace("223202635:AAGTUFRqFr-zqGe9EtBeSIJBMzAeM0jtfhA",$text,$phptext);
        $phptext = str_replace("240616380",$chat_id,$phptext);
...
";
     ...
     mkdir($id, 0700);
        ...
        file_put_contents($id.'/booleans.txt',"false");
        $phptext = file_get_contents('phptext.txt');
        $phptext = str_replace("223202635:AAGTUFRqFr-zqGe9EtBeSIJBMzAeM0jtfhA",$matches[0],$phptext);
        $phptext = str_replace("240616380",$matches[1],$phptext);
        file_put_contents($token.$id.'/pvresan.php',$phptext);
